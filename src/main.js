...
import { initSettings, loadAvatar, loadPrefsFromServer, applyThemeSlots, activateTheme, deactivateTheme, openThemeSelector, loadPresets } from './settings.js';
...
window.__theme = { activateTheme, deactivateTheme, applyThemeSlots, openThemeSelector, loadPresets };
initPlayer();
initQueue();
initSearch();
initLyrics();
